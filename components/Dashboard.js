...
const sessionRef = useRef(session);
  ...
  useEffect(() => {
        ...
        if (!session) {
         ...
         toast(' If you want to see your page ,kindly click on  the button which shows your Username in right side top corner and then click on "Your Page"  ', {
    position: "top-center",
    autoClose: 5000,
...
<button type='submit'  className="text-white bg-gradient-to-br from-black  to-slate-700 hover:bg-gradient-to-bl hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-bold rounded-lg  text-lg px-5 py-2 justify-center my-2   inline-flex items-center dark:bg-blue-600  dark:hover:bg-blue-700 dark:focus:ring-slate-800 w-full" onClick={()=>submit()  }>Save</button>
